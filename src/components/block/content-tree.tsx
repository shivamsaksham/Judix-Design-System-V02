...
export function ContentTree({
  ...
  return (
    <div
      className={cn(
        `flex h-full flex-col items-end gap-2
      ...
      >
        {sections.map((section) => (
          ...
          >
            ...
            <div className="flex p-2 pl-[26px] content-end items-center gap-2 self-stretch ">
              <div className="flex ml-auto w-full flex-col items-start gap-1">
                {/*  tabs  */}
