...
export function SearchScopeSelector({
    ...
    return (
        <div
            className={cn(
                "py-4 bg-color-surface-neutral-default rounded-2xl shadow-sm border border-color-border-neutral-default w-full max-w-[353px] max-h-[130px] flex flex-col gap-3",
                className
            )}
            {...props}
        >
