...
export const SidebarActionButtons = ({ onNewChat, onNotes, onProjects, onLibrary, style }: SidebarActionButtonsProps) => {
    return (
        <div className="p-1 mr-3 ml-1 mb-2" style={style}>
            ...
            >
                <IconButton
                    ...
                    className="mr-0 pointer-events-none bg-transparent hover:bg-transparent border-none"
                />
                <div className="p-1 text-style-body-default-regular text-color-text-neutral-default">Library</div>
            </div>
            <div
                onClick={onProjects}
